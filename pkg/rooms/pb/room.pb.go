...
var file_room_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x22, 0xe4, 0x01, 0x0a, 0x09, 0x52, 0x6f,
	0x6f, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2f, 0x0a, 0x07, 0x6d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x52,
	...
	0x1a, 0x7e, 0x0a, 0x0a, 0x52, 0x6f, 0x6f, 0x6d, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x0e,
	...
	0x0c, 0x52, 0x03, 0x73, 0x64, 0x70, 0x32, 0x39, 0x0a, 0x0b, 0x52, 0x6f, 0x6f, 0x6d, 0x53, 0x65,
...
var file_room_proto_goTypes = []interface{}{
	...
	(*CreateReply)(nil),             // 8: CreateReply
	(*Trickle)(nil),                 // 9: Trickle
	(*SessionDescription)(nil),      // 10: SessionDescription
	(*SignalRequest_Command)(nil),   // 11: SignalRequest.Command
	(*SignalReply_Event)(nil),       // 12: SignalReply.Event
	(*RoomState_RoomMember)(nil),    // 13: RoomState.RoomMember
}
var file_room_proto_depIdxs = []int32{
	4,  // 0: SignalRequest.join:type_name -> JoinRequest
	7,  // 1: SignalRequest.create:type_name -> CreateRequest
	10, // 2: SignalRequest.negotiate:type_name -> SessionDescription
	9,  // 3: SignalRequest.trickle:type_name -> Trickle
	11, // 4: SignalRequest.command:type_name -> SignalRequest.Command
	5,  // 5: SignalReply.join:type_name -> JoinReply
	8,  // 6: SignalReply.create:type_name -> CreateReply
	10, // 7: SignalReply.negotiate:type_name -> SessionDescription
	9,  // 8: SignalReply.trickle:type_name -> Trickle
	12, // 9: SignalReply.event:type_name -> SignalReply.Event
	10, // 10: JoinReply.answer:type_name -> SessionDescription
	6,  // 11: JoinReply.room:type_name -> RoomState
	13, // 12: RoomState.members:type_name -> RoomState.RoomMember
	10, // 13: CreateReply.answer:type_name -> SessionDescription
	0,  // 14: SignalRequest.Command.type:type_name -> SignalRequest.Command.Type
	1,  // 15: SignalReply.Event.type:type_name -> SignalReply.Event.Type
	2,  // 16: RoomService.Signal:input_type -> SignalRequest
	3,  // 17: RoomService.Signal:output_type -> SignalReply
