...
var file_room_proto_rawDesc = []byte{
	...
	0x73, 0x72, 0x63, 0x22, 0x3d, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
	...
	0x6f, 0x6e, 0x22, 0x4a, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c,
	...
	0x02, 0x69, 0x64, 0x32, 0x69, 0x0a, 0x0b, 0x52, 0x6f, 0x6f, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2a, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x12, 0x0e, 0x2e, 0x53,
	0x69, 0x67, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x53,
	0x69, 0x67, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x28, 0x01, 0x30, 0x01, 0x12, 0x2e,
	0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x1a, 0x09, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x0e,
...
var file_room_proto_goTypes = []interface{}{
	...
	(*RoomList)(nil),                // 6: RoomList
	(*RoomState)(nil),               // 7: RoomState
	(*CreateRequest)(nil),           // 8: CreateRequest
	(*CreateReply)(nil),             // 9: CreateReply
	(*Trickle)(nil),                 // 10: Trickle
	(*SessionDescription)(nil),      // 11: SessionDescription
	(*Invite)(nil),                  // 12: Invite
	(*SignalRequest_Command)(nil),   // 13: SignalRequest.Command
	(*SignalReply_Event)(nil),       // 14: SignalReply.Event
	(*RoomState_RoomMember)(nil),    // 15: RoomState.RoomMember
	(*empty.Empty)(nil),             // 16: google.protobuf.Empty
}
var file_room_proto_depIdxs = []int32{
	4,  // 0: SignalRequest.join:type_name -> JoinRequest
	8,  // 1: SignalRequest.create:type_name -> CreateRequest
	11, // 2: SignalRequest.negotiate:type_name -> SessionDescription
	10, // 3: SignalRequest.trickle:type_name -> Trickle
	13, // 4: SignalRequest.command:type_name -> SignalRequest.Command
	12, // 5: SignalRequest.invite:type_name -> Invite
	5,  // 6: SignalReply.join:type_name -> JoinReply
	9,  // 7: SignalReply.create:type_name -> CreateReply
	11, // 8: SignalReply.negotiate:type_name -> SessionDescription
	10, // 9: SignalReply.trickle:type_name -> Trickle
	14, // 10: SignalReply.event:type_name -> SignalReply.Event
	11, // 11: JoinReply.answer:type_name -> SessionDescription
	7,  // 12: JoinReply.room:type_name -> RoomState
	7,  // 13: RoomList.rooms:type_name -> RoomState
	15, // 14: RoomState.members:type_name -> RoomState.RoomMember
	11, // 15: CreateReply.answer:type_name -> SessionDescription
	0,  // 16: SignalRequest.Command.type:type_name -> SignalRequest.Command.Type
	1,  // 17: SignalReply.Event.type:type_name -> SignalReply.Event.Type
	2,  // 18: RoomService.Signal:input_type -> SignalRequest
	16, // 19: RoomService.ListRooms:input_type -> google.protobuf.Empty
	3,  // 20: RoomService.Signal:output_type -> SignalReply
	6,  // 21: RoomService.ListRooms:output_type -> RoomList
