...
type Event_Muted_ struct {
	Muted *Event_Muted `protobuf:"bytes,4,opt,name=muted,proto3,oneof"`
}

type Event_Unmuted_ struct {
	Unmuted *Event_Unmuted `protobuf:"bytes,5,opt,name=unmuted,proto3,oneof"`
}

type Event_Reacted_ struct {
	Reacted *Event_Reacted `protobuf:"bytes,6,opt,name=reacted,proto3,oneof"`
}

type Event_LinkShared_ struct {
	LinkShared *Event_LinkShared `protobuf:"bytes,7,opt,name=linkShared,proto3,oneof"`
}

type Event_InvitedAdmin_ struct {
	InvitedAdmin *Event_InvitedAdmin `protobuf:"bytes,8,opt,name=invitedAdmin,proto3,oneof"`
}

type Event_AddedAdmin_ struct {
	AddedAdmin *Event_AddedAdmin `protobuf:"bytes,9,opt,name=addedAdmin,proto3,oneof"`
}

type Event_RemovedAdmin_ struct {
	RemovedAdmin *Event_RemovedAdmin `protobuf:"bytes,10,opt,name=removedAdmin,proto3,oneof"`
}

type Event_RenamedRoom_ struct {
	RenamedRoom *Event_RenamedRoom `protobuf:"bytes,11,opt,name=renamedRoom,proto3,oneof"`
}

type Event_RecordedScreen_ struct {
	RecordedScreen *Event_RecordedScreen `protobuf:"bytes,12,opt,name=recordedScreen,proto3,oneof"`
}

type Event_MutedByAdmin_ struct {
	MutedByAdmin *Event_MutedByAdmin `protobuf:"bytes,13,opt,name=mutedByAdmin,proto3,oneof"`
}
...
var file_room_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x9b, 0x07,
	...
	,
	...
	0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x12,
	0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f,
	0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x0a, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b, 0x2e, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c,
