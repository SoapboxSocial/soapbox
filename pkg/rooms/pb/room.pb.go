...
var file_room_proto_rawDesc = []byte{
	...
	0x56, 0x41, 0x54, 0x45, 0x10, 0x01, 0x32, 0x69, 0x0a, 0x0b, 0x52, 0x6f, 0x6f, 0x6d, 0x53, 0x65,
...
var file_room_proto_goTypes = []interface{}{
	...
	(*SignalRequest_Command)(nil),   // 19: SignalRequest.Command
	(*SignalReply_Event)(nil),       // 20: SignalReply.Event
	(*RoomState_RoomMember)(nil),    // 21: RoomState.RoomMember
	(*RoomState_Group)(nil),         // 22: RoomState.Group
...
var file_room_proto_depIdxs = []int32{
	...
	19, // 4: SignalRequest.command:type_name -> SignalRequest.Command
	13, // 5: SignalRequest.invite:type_name -> Invite
	14, // 6: SignalRequest.kick:type_name -> Kick
	6,  // 7: SignalReply.join:type_name -> JoinReply
	10, // 8: SignalReply.create:type_name -> CreateReply
	12, // 9: SignalReply.negotiate:type_name -> SessionDescription
	11, // 10: SignalReply.trickle:type_name -> Trickle
	20, // 11: SignalReply.event:type_name -> SignalReply.Event
	12, // 12: JoinReply.answer:type_name -> SessionDescription
	8,  // 13: JoinReply.room:type_name -> RoomState
	8,  // 14: RoomList.rooms:type_name -> RoomState
	21, // 15: RoomState.members:type_name -> RoomState.RoomMember
	0,  // 16: RoomState.visibility:type_name -> Visibility
	22, // 17: RoomState.group:type_name -> RoomState.Group
	0,  // 18: CreateRequest.visibility:type_name -> Visibility
	12, // 19: CreateReply.answer:type_name -> SessionDescription
	1,  // 20: SignalRequest.Command.type:type_name -> SignalRequest.Command.Type
	2,  // 21: SignalReply.Event.type:type_name -> SignalReply.Event.Type
	3,  // 22: RoomService.Signal:input_type -> SignalRequest
	23, // 23: RoomService.ListRooms:input_type -> google.protobuf.Empty
	4,  // 24: RoomService.Signal:output_type -> SignalReply
	7,  // 25: RoomService.ListRooms:output_type -> RoomList
